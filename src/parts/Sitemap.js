		...
		<div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
			<h5 className="text-lg font-semibold mb-2 relative">
				...
				<button
					...
					className={[
						'absolute block md:hidden right-0 transform top-1/2 -translate-1/2 focus:outline-none transition duration-200',
		...
		<section className="">
			<div className="border-t border-b border-gray-200 py-12 mt-16 px-4">
				<div className="flex justify-center mb-8">
					<img
						src="/images/content/Logohead.png"
						...
						<div className="px-4 w-full md:w-3/12 mb-4 md:mb-0">
							...
							<form action="#">
								<label className="relative w-full">
									...
									/>
									<button className="bg-blue-200 absolute rounded-xl right-0 p-3">
										<svg
											width="24"
											height="24"
											viewBox="0 0 24 24"
